...
export const metadata: Metadata = {
  title: "About Us",
  description: `${site.name} is comprised of marine experts who have completed projects since ${site.experienceSince} — over 40 years of combined experience across Asia and Micronesia.`,
};
...
export default function AboutPage() {
  return (
    <>
      <PageHero
        title="About Us"
        subtitle={`A team of marine experts with over 40 years of combined experience across Asia and Micronesia.`}
        breadcrumb="About Us"
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 leading-relaxed text-charcoal/75">
                {site.name} is comprised of marine experts whose combined track
                record spans marine and civil infrastructure projects since{" "}
                {site.experienceSince}. With more than 40 years of combined
